...
;@ ensures  (full_mul_f32_post1 %ret %a %b)
  ...
  %6 = and i32 %4, %5
  %7 = bitcast i32 %6 to float
  %8 = call float @ctfp_full_mul_f32v1_2(float %7, float %b)
  ret float %8
}
...
;@ ensures  (full_mul_f32_post2 %ret %a %b)
  ...
  %6 = and i32 %4, %5
  %7 = bitcast i32 %6 to float
  %8 = call float @ctfp_full_mul_f32v1_3(float %a, float %7)
  ret float %8
}
...
;@ ensures  (full_mul_f32_post3 %ret %a %b)
  ...
  %16 = call float @ctfp_full_mul_f32v1_4(float %12, float %15)
